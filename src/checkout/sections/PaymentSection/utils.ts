...
import { hyperswitchGatewayId } from "./HyperswitchSDK/hyperswitchSDK";
import {
...
export const supportedPaymentGateways = [adyenGatewayId, stripeGatewayId, hyperswitchGatewayId] as const;
